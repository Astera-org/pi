...
async function loadModelsDevData(): Promise<Model<any>[]> {
	try {
		...
		// models.dev split the former "kimi-for-coding" key into "kimi-code-plan-global" and
		// "kimi-code-plan-cn"; we source from the global catalog since this repo only registers
		// a single (non-China) kimi-coding provider.
